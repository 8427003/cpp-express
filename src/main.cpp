...
#include "routers/CommonFactory.h"
...
int main(int argc, char* argv[]) {
  ...
  //google::SetLogDestination(google::INFO, "log/cpp_express_info_");
  //google::SetLogDestination(google::ERROR, "log/cpp_express_error_");
